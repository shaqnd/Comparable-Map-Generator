  ...
  var Store = {
    ...
    blankProject: function () {
      return {
        ...
        /* Reserved for the environment model: one environment per assessor's
           office or appraisal company. Inside an environment nothing is hidden —
           a subject address is the firm's own work product. Redaction happens
           only when someone outside the environment reads the shared corpus,
           which makes it a read-time projection rather than something stripped
           on save. Unset until there is a server to enforce it. */
        environmentId: null,
        createdBy: null,
